 ...
 */
export async function expectAlertWithMessage(page: Page, expectedMessage: string): Promise<void> {
 ...
 * Automatically accepts the dialog after verification
 */
export async function expectAlertContaining(page: Page, substring: string): Promise<void> {
    const dialogPromise = new Promise<string>((resolve, reject) => {
        const timeout = setTimeout(() => {
