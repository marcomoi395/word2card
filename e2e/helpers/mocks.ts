 ...
 */
export async function mockOpenAI(page: Page, words: string[], scenario: 'success' | 'failure' = 'success') {
 ...
 */
export async function mockNotion(page: Page, words: string[], scenario: 'success' | 'failure' = 'success') {
  // Mock database query
 ...
 */
export async function setupApiKeys(page: Page, keys = {
